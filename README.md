...
Also similar to how you can label a namespace, there may be resources that you dont want to collect (eg. storageclass), so
you should use [white/black lists](#whiteblack-lists) to limit what is collected. Note: using the white/black list will
effect all resources polled, namespaced and non namespace.
